...
public class ShoppingCartAdditionModal extends AppCompatDialogFragment {
    private ShoppingCartAdditionModal.ShoppingCartAdditionDialogListener listener;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (ShoppingCartAdditionModal.ShoppingCartAdditionDialogListener) context;
        } catch (ClassCastException e) {
            throw new ClassCastException(context.toString() +
                    "Must implement ShoppingCartAdditionDialogListner");
        }

    }

    public interface ShoppingCartAdditionDialogListener{
